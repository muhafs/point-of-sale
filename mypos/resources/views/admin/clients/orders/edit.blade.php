...
<div class="container">
    <div class="row justify-content-between">
        ...
        <div class="col-md-6">
            <div class="card">
                <form action="{{ route('clients.orders.update', ['order' => $order->id, 'client' => $client->id]) }}"
                    method="post">
                    @csrf
                    @method('put')
                    <div class="card-header bg-primary">
                    ...
                    <div class="card-footer">
                        <h4 class="text-center">Total: SAR. <span
                                class="total-price">{{ number_format($order->total_price) }}</span></h4>
                        <button class="btn btn-primary w-100" id="form-btn">
